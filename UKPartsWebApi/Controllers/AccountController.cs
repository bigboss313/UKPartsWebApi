...
namespace UKPartsWebApi.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Registration(RegisterBindingModel model)
        {
            ...
            if (userInfo != null)
            {
                return Ok(new ResponseModel { Message = "Username already exists.", Status = "Fail" });
            }
            else
            {
            ...
            return Ok(new ResponseModel { Message = "User registered successfully.", Status = "Success" });
        }
        /// <summary>
        /// TODO:User Login By Valid Credentials.
        /// </summary>
        ...
        public async Task<IHttpActionResult> UserLogin(LoginModel model)
        {
            ...
            if (user != null)
            {
                ...
                {
                    return Ok(new ResponseModel { Message = "User name or password invalid.", Status = "Fail" });
                }
                else
                {
                    try
                    {
                        ...
                        return Ok(new ResponseModel { Message = "User login successfully.", Status = "Success", Data = usermodel });
                    }
                    catch (Exception ex)
                    {
        ...
        [ResponseType(typeof(List<CountryModel>))]
        [HttpGet]
        [AllowAnonymous]
        ...
        public IHttpActionResult GetCountryList()
        {
            using (UKPartsDBEntities db = new UKPartsDBEntities())
            {
                ...
                return Ok(new ResponseModel { Message = "CountryList", Status = "Success", Data = countryList });
            }
        }
